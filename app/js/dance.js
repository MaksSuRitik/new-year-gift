...
const songsDB = [
    ...
    { file: "...Baby One More Time (from Kung Fu Panda 4).mp3", title: "...Baby One More Time (from Kung Fu Panda 4)", artist: "Tenacious D", duration: "3m 13s" },
    ...
    { file: "Beethoven Virus - Ultimate Version.mp3", title: "Beethoven Virus - Ultimate Version", artist: "logan feece", duration: "3m 38s" },
    ...
    { file: "Est-ce que tu m'aimes - Pilule bleue.mp3", title: "Est-ce que tu m'aimes ? - Pilule bleue", artist: "GIMS", duration: "3m 57s" },
    ...
    { file: "GOSSIP (feat. Tom Morello).mp3", title: "GOSSIP (feat. Tom Morello)", artist: "Måneskin, Tom Morello", duration: "2m 48s" },
    ...
    { file: "Kyouran Hey Kids!! - Noragami Aragoto.mp3", title: "Kyouran Hey Kids!! - Noragami Aragoto", artist: "Animelmack", duration: "4m 10s" },
    { file: "Lay All Your Love On Me.mp3", title: "Lay All Your Love On Me", artist: "ABBA", duration: "4m 34s" },
    { file: "Leave a Light On - Jayson DeZuzio Remix.mp3", title: "Leave a Light On - Jayson DeZuzio Remix", artist: "Tom Walker, Jayson DeZuzio", duration: "3m 11s" },
    { file: "Mary On A Cross.mp3", title: "Mary On A Cross", artist: "Ghost", duration: "4m 05s" },
    { file: "Me and the Devil - Nightcore.mp3", title: "Me and the Devil - Nightcore", artist: "neko, Tazzy", duration: "2m 32s" },
    { file: "phantasmagoria.mp3", title: "phantasmagoria", artist: "mzlff", duration: "2m 13s" },
    { file: "ReawakeR (feat. Felix of Stray Kids).mp3", title: "ReawakeR (feat. Felix of Stray Kids)", artist: "LiSA, Felix", duration: "3m 05s" },
    ...
    { file: "Take Me to the Beach (feat. Ado).mp3", title: "Take Me to the Beach (feat. Ado)", artist: "Imagine Dragons, Ado", duration: "2m 47s" },
    { file: "The Death of God's Will.mp3", title: "The Death of God's Will", artist: "Heaven Pierce Her", duration: "5m 11s" },
    { file: "Treachery (Aizen's Theme).mp3", title: "Treachery (Aizen's Theme)", artist: "Crystilo", duration: "4m 43s" },
